# Sama kasus nya dengan mangacanblog , tidak menemukan content-length di header dari requests head. Terpaksa mendownload terlebih dahulu gambarnya
...
class helper():
    ...
    def judul(self):
        ...
        judul = re.sub('(.+?)\s[chapter]{6,7}.+','\g<1>', title).split("/")[0].title().strip()
        return judul
